function [Ypk,Xpk,Wpk,Ppk, wxPk] = findpeaks_ho(Yin,varargin)

%findpeaks(y,x,'Annotate','extents', 'MinPeakProminence', minpeakprominence)
%Yin = y;
% [Ypk,Xpk,Wpk,Ppk, wxPk] = findpeaks_hisa_181225(y,x,'Annotate','extents', 'MinPeakProminence', minpeakprominence);
...
function [YpkOut,XpkOut,WpkOut,PpkOut] = assignFullOutputs(y,x,iPk,wxPk,bPk,yIsRow,xIsRow) %18/12/25 rewrite
