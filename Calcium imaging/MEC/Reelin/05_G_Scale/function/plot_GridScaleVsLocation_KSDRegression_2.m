function [slope, x_at_target] = plot_GridScaleVsLocation_KSDRegression_2(data, peaks, xlims, ylims)
% Plot grid scale against dorsal distance and fit a regression line through KSD peak locations.

    hold on

    scatter(data(:,3), -2050-data(:,1), 30, 'k', 'filled')
