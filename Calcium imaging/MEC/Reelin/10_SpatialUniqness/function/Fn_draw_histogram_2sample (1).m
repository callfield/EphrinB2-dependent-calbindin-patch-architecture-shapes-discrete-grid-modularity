...
histogram(DATA1,"BinWidth",BIN,"Normalization","probability")
hold on
histogram(DATA2,"BinWidth",BIN,"Normalization","probability")
h1.LineWidth=2;
h2.LineWidth=2;
h1.Color="black";
...
legend(SAMPLELABELS(1),SAMPLELABELS(2),'Location','northwest','FontSize',15);
