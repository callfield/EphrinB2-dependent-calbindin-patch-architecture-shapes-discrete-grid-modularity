...
%              NAME="GridMod1&2";
        [ Min_meanErrDist1 Min_maxErrDist1]= Fn_CorrDecode_NormCellNum_GridMod_230324(DIR,All_CELLSET,R2ID,NAME);
       
        
              All_CELLSET=Grid_Cells(Mod{s,t}{2});         
        [ Min_meanErrDist2 Min_maxErrDist2]= Fn_CorrDecode_NormCellNum_GridMod_230324(DIR,All_CELLSET,R2ID,NAME);
